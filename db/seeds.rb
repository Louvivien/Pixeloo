...
#items = Item.create!(title: "lumix 45-200", description: a, price: "20€", user_id: "1", category_id: "3", image_url:  "wesh")
 #items.item_image.attach(io: File.open('app/assets/images/objectifs2/lumix45-200.png'), filename: 'lumix45-200.png', content_type: 'image/png')

#items = Item.create!(title: "lumix 42-600", description: a, price: "35€", user_id: "1", category_id: "3", image_url:  "wesh")
 #items.item_image.attach(io: File.open('app/assets/images/objectifs2/lumix42-600.png'), filename: 'lumix42-600.png', content_type: 'image/png')
...
#items = Item.create!(title: "canon speedlite-430", description: a, price: "20€", user_id: "1", category_id: "2", image_url: "wesh")
 #items.item_image.attach(io: File.open('app/assets/images/éclairage3/canonspeedlite-430.png'), filename: 'canonspeedlite-430.png', content_type: 'image/png')
...
#items = Item.create!(title: "canon speedlite-600", description: a, price: "30€", user_id: "1", category_id: "2", image_url:  "wesh")
 #items.item_image.attach(io: File.open('app/assets/images/éclairage3/canonspeedlite-600.png'), filename: 'canonspeedlite-600.png', content_type: 'image/png')
